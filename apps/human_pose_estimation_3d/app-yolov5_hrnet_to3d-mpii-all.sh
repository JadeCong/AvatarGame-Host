...
###
 # @Author: Jade Cong
 # @Date: 2020-12-30 10:14:51
 # @LastEditTime: 2021-01-05 10:56:53
 # @LastEditors: Please set LastEditors
 # @Description: application of 3D human pose estimation for live or video mode
 # @FilePath: /Workflows/server/PycharmProjects/Pacific_AvatarGame_Host/apps/human_pose_estimation_3d/app-yolov5_hrnet_to3d-mpii-all.sh
### 
...
python3 app-yolov5_hrnet_to3d-mpii-all.py \
    --config app-yolov5_hrnet_to3d-mpii-all.yaml \
    --device 0 \
    --local_rank 0 \
    --seed 26 \
    --weights $(cd $(dirname $0) && cd ../../data && pwd -P)/weights/pretrained/yolov5/pytorch/yolov5/yolov5s.pt \
    --source "/home/pacific/Documents/Work/Projects/Workflows/server/PycharmProjects/Pacific_AvatarGame_Host/resources/videos/example_640x480.avi" \
    --img_size 640 \
    --conf_thres 0.8 \
    --view_img \
    --save_img \
