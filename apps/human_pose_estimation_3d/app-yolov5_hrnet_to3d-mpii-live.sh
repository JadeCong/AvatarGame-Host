...
###
 ...
 # @LastEditTime: 2021-01-05 10:57:38
 # @LastEditors: Please set LastEditors
 # @Description: In User Settings Edit
 # @FilePath: /Workflows/server/PycharmProjects/Pacific_AvatarGame_Host/apps/human_pose_estimation_3d/app-yolov5_hrnet_to3d-mpii-live.sh
### 
...
python3 app-yolov5_hrnet_to3d-mpii-live.py \
    --config app-yolov5_hrnet_to3d-mpii-live.yaml \
    --device 0 \
    --local_rank 0 \
    --seed 26 \
