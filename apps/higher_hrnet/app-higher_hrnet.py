...
import sys
sys.path.append("../../nns/higher_hrnet")
import time
...
COCO_SKELETON_INDEXES = [
    [0, 1, COCO_SKELETON_COLORS["color1"]], [1, 3, COCO_SKELETON_COLORS["color1"]], [3, 5, COCO_SKELETON_COLORS["color1"]],
    [0, 2, COCO_SKELETON_COLORS["color2"]], [2, 4, COCO_SKELETON_COLORS["color2"]], [4, 6, COCO_SKELETON_COLORS["color2"]],
    [5, 7, COCO_SKELETON_COLORS["color3"]], [7, 9, COCO_SKELETON_COLORS["color3"]],  
    [6, 8, COCO_SKELETON_COLORS["color4"]], [8, 10, COCO_SKELETON_COLORS["color4"]], 
    [11, 13, COCO_SKELETON_COLORS["color3"]], [13, 15, COCO_SKELETON_COLORS["color3"]], 
    [12, 14, COCO_SKELETON_COLORS["color4"]], [14, 16, COCO_SKELETON_COLORS["color4"]], 
    [6, 5, COCO_SKELETON_COLORS["color5"]], [5, 11, COCO_SKELETON_COLORS["color5"]], [11, 12, COCO_SKELETON_COLORS["color5"]], [12, 6, COCO_SKELETON_COLORS["color5"]], [1, 2, COCO_SKELETON_COLORS["color5"]]
]
...
def main():
    ...
    while vidcap.isOpened():
        ...
        # calculate the detection time and FPS
        total_then = time.time()
        detect_time = total_then - total_now
        detect_fps = 1.0 / detect_time
        print("2D Human Pose Detection in FPS: {:.2f}".format(detect_fps))
        ...
        cv2.putText(image_debug, "2D Human Pose", (470, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2, cv2.LINE_AA)

        # show the image stream in window
        cv2.namedWindow("2D Human Pose",cv2.WINDOW_NORMAL)
        cv2.imshow("2D Human Pose", image_debug)
