...
# launch the application for 2d human pose estimation(yolov5 and resnet) with MPII dataset
python3 app-yolov5_resnet-mpii.py \
    --config app-yolov5_resnet-mpii.yaml \
    --device 0 \
    --local_rank 0 \
    --seed 26 \
